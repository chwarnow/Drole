...
public class VSMShadowPass extends RenderPass {
	...
	private String dataPath = "shader/passes/vsmshader/";
	...
	public VSMShadowPass(Engine e) {
		...
		composeShader = new GLSLShader(e.p, dataPath + "VertexShader.glsl", dataPath + "FragmentShader.glsl");
		storeDepthShader = new GLSLShader(e.p, dataPath + "StoreDepthVertexShader.glsl", dataPath + "StoreDepthFragmentShader.glsl");
		blurShader = new GLSLShader(e.p, dataPath + "BlurVertexShader.glsl", dataPath + "BlurFragmentShader.glsl");
...
//		gl.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_GENERATE_MIPMAP, GL.GL_TRUE);
	...
	private void blurShadowMap() {
		...
		blurShader.start();
		blurShader.setVecUniform("ScaleU", 1.0f / (g.width * SHADOW_MAP_COEF * BLUR_COEF), 0.0f);
		...
		blurShader.setVecUniform("ScaleU", 0.0f, 1.0f / (g.height * SHADOW_MAP_COEF));	
...
//		gl.glGenerateMipmapEXT(GL.GL_TEXTURE_2D);
		...
		*/
		...
		composeShader.setFloatUniform("xPixelOffset", 1.0f / (g.width * SHADOW_MAP_COEF));
		composeShader.setFloatUniform("yPixelOffset", 1.0f / (g.height * SHADOW_MAP_COEF));
