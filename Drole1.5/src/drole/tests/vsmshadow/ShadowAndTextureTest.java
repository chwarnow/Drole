...
public class ShadowAndTextureTest extends PApplet {
	...
	*/
	...
	private PImage permTexture;
	private int permTextureID;
	...
	public void setup() {
		  ...
		  composeShader = new GLSLShader(this, dataPath+"TextureVertexShader.glsl", dataPath+"TextureFragmentShader.glsl");
		...
		gl.glHint(GL.GL_LINE_SMOOTH_HINT, GL.GL_NICEST);
			*/
	        ...
	        permTextureID = genTexture(gl);
	        println(permTextureID);
	        gl.glBindTexture(GL.GL_TEXTURE_2D, permTextureID);
	        TextureReader.Texture texture = null;
	        try {
	            texture = TextureReader.readTexture("data/images/boxTexture.jpg");
	        } catch (IOException e) {
	            e.printStackTrace();
...
//		gl.glGenerateMipmapEXT(GL.GL_TEXTURE_2D);
		...
		*/
		...
		gl.glActiveTexture(GL.GL_TEXTURE0);
		gl.glBindTexture(GL.GL_TEXTURE_2D, permTextureID);
		composeShader.setTexUniform("permTexture", permTextureID);
...
//		gl.glCullFace(GL.GL_BACK);
	...
	public static void main(String args[]) {
		PApplet.main(new String[] {
			"drole.tests.vsmshadow.ShadowAndTextureTest"
		});
	}
