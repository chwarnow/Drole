...
public class DLASpiral extends PApplet {
	...
	public void setup() {
	  ...
	  for(float theta =- TWO_PI, r = 20; theta < 0.02f * TWO_PI; theta += QUARTER_PI) {
	...
	class DLAListener extends DLAEventAdapter {
	  ...
	  public void dlaAllSegmentsProcessed(DLA dla) {
	    println("all done after '"+nums+"' * 10000 updates, saving...");
	    save();
	  }
...
//	    dla.save(sketchPath("spiral.dla"), false);
	    dla.saveAsText(sketchPath("spiral.dla"), false);
	    */
		  List<Vec3D> dlaPoints = dla.getParticles();
	...
	public static void main(String[] arg) {
		PApplet.main(new String[]{"drole.tests.dla.DLASpiral"});
	}
