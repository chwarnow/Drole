...
public class GesturesMain extends PApplet implements PositionTargetListener {
	...
	private PositionTarget holdingTargetBox;
...
//	  TargetSphere holdingTargetShape = new TargetSphere(0, 50, -250, 300);
//	  holdingTarget = new PositionTarget(this, "HOLDING_TARGET", context, holdingTargetShape, SimpleOpenNI.SKEL_RIGHT_HAND, SimpleOpenNI.SKEL_TORSO);
		...
		pushStyle();
			...
			pushMatrix();
				...
				if(zoomTargetActive) {
					...
					size += map(rightHand.dist(torso), 300, 100, 0, 200);
				}
