...
public class FunkyFun extends SimpleMotionScene implements MotionDetectionListener {
	...
	private WalkDetector wd = new WalkDetector(20f);
	
	public FunkyFun(PApplet p, int code, int fadeSpeed, Minim minim) {
