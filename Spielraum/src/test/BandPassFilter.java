...
public class BandPassFilter extends PApplet {
...
public void setup()
{
 ...
 groove = minim.loadFile("data/sound/groove.mp3");
 groove.loop();
...
//	PApplet.main(new String[] {"--display=2", "--full-screen", "xx.codeflower.spielraum.motion.MApplet"});
	PApplet.main(new String[] {"--display=2", "test.BandPassFilter"});
}
